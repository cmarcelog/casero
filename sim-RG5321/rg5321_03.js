...
openModal.addEventListener("click", (e) => {
    ...
    if (tasa != 0 && consolida != 0) {
        ...
        mParagraph.innerHTML = `De acuerdo a los datos ingresados puede acceder a<br>${cc[2]} cuotas de $ ${cc[1]}, aproximadamente.`; // le doy el contenido a p
